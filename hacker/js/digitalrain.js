...
$packages["main"] = (function() {
	...
	js = $packages["github.com/gopherjs/gopherjs/js"];
	Duration = $pkg.Duration = $newType(8, $kindFloat64, "main.Duration", true, "main", true, null);
	DigitalRain = $pkg.DigitalRain = $newType(0, $kindStruct, "main.DigitalRain", true, "main", true, function(parent_, canvas_, ctx_, width_, height_, ratio_, timestamp_, lowGlyphCanvas_, highGlyphCanvas_, drops_, linkover_, screenCols_, minSpeed_, maxSpeed_, brightness_, Clicked_) {
		this.$val = this;
		if (arguments.length === 0) {
			this.parent = null;
			this.canvas = null;
	...
	waterDrop = $pkg.waterDrop = $newType(0, $kindStruct, "main.waterDrop", true, "main", false, function(col_, row_, start_, speed_, glyphs_, spedup_, created_) {
		this.$val = this;
		if (arguments.length === 0) {
			this.col = 0;
			this.row = 0;
	...
	GlyphCanvas = $pkg.GlyphCanvas = $newType(0, $kindStruct, "main.GlyphCanvas", true, "main", true, function(jso_, glyphs_) {
		this.$val = this;
		if (arguments.length === 0) {
			this.jso = null;
			this.glyphs = false;
	...
	main = function() {
		...
		$global.addEventListener($externalize("load", $String), $externalize((function $b() {
			...
			$s = -1; return;
			/* */ } return; } if ($f === undefined) { $f = { $blk: $b }; } $f._r = _r; $f._r$1 = _r$1; $f._tuple = _tuple; $f._tuple$1 = _tuple$1; $f.cover = cover; $f.err = err; $f.rain1 = rain1; $f.rain2 = rain2; $f.$s = $s; $f.$r = $r; return $f;
		}), funcType));
	};
	itoa = function(i) {
		var i;
	...
	DigitalRain.ptr.prototype.dropWaterAtCol = function(col, speed, length, start, created) {
		var _r, col, created, i, length, r, speed, start, wd, x;
		r = this;
	...
	DigitalRain.ptr.prototype.dropRandomWaterDrop = function(timestamp) {
		var _i, _q, _r, _r$1, _r$2, _r$3, _ref, col, colcnt, drop, length, r, speed, start, timestamp;
		r = this;
	...
	DigitalRain.init("main", [{prop: "parent", name: "parent", anonymous: false, exported: false, typ: ptrType$3, tag: ""}, {prop: "canvas", name: "canvas", anonymous: false, exported: false, typ: ptrType$3, tag: ""}, {prop: "ctx", name: "ctx", anonymous: false, exported: false, typ: ptrType$3, tag: ""}, {prop: "width", name: "width", anonymous: false, exported: false, typ: $Float64, tag: ""}, {prop: "height", name: "height", anonymous: false, exported: false, typ: $Float64, tag: ""}, {prop: "ratio", name: "ratio", anonymous: false, exported: false, typ: $Float64, tag: ""}, {prop: "timestamp", name: "timestamp", anonymous: false, exported: false, typ: Duration, tag: ""}, {prop: "lowGlyphCanvas", name: "lowGlyphCanvas", anonymous: false, exported: false, typ: ptrType, tag: ""}, {prop: "highGlyphCanvas", name: "highGlyphCanvas", anonymous: false, exported: false, typ: ptrType, tag: ""}, {prop: "drops", name: "drops", anonymous: false, exported: false, typ: sliceType$2, tag: ""}, {prop: "linkover", name: "linkover", anonymous: false, exported: false, typ: $Bool, tag: ""}, {prop: "screenCols", name: "screenCols", anonymous: false, exported: false, typ: $Int, tag: ""}, {prop: "minSpeed", name: "minSpeed", anonymous: false, exported: false, typ: $Int, tag: ""}, {prop: "maxSpeed", name: "maxSpeed", anonymous: false, exported: false, typ: $Int, tag: ""}, {prop: "brightness", name: "brightness", anonymous: false, exported: false, typ: $Float64, tag: ""}, {prop: "Clicked", name: "Clicked", anonymous: false, exported: true, typ: funcType, tag: ""}]);
	waterDrop.init("main", [{prop: "col", name: "col", anonymous: false, exported: false, typ: $Int, tag: ""}, {prop: "row", name: "row", anonymous: false, exported: false, typ: $Float64, tag: ""}, {prop: "start", name: "start", anonymous: false, exported: false, typ: $Float64, tag: ""}, {prop: "speed", name: "speed", anonymous: false, exported: false, typ: $Float64, tag: ""}, {prop: "glyphs", name: "glyphs", anonymous: false, exported: false, typ: sliceType$3, tag: ""}, {prop: "spedup", name: "spedup", anonymous: false, exported: false, typ: $Bool, tag: ""}, {prop: "created", name: "created", anonymous: false, exported: false, typ: Duration, tag: ""}]);
	GlyphCanvas.init("main", [{prop: "jso", name: "jso", anonymous: false, exported: false, typ: ptrType$3, tag: ""}, {prop: "glyphs", name: "glyphs", anonymous: false, exported: false, typ: mapType$1, tag: ""}]);
	$init = function() {
		$pkg.$init = function() {};
		/* */ var $f, $c = false, $s = 0, $r; if (this !== undefined && this.$blk !== undefined) { $f = this; $c = true; $s = $f.$s; $r = $f.$r; } s: while (true) { switch ($s) { case 0:
		$r = js.$init(); /* */ $s = 1; case 1: if($c) { $c = false; $r = $r.$blk(); } if ($r && $r.$blk !== undefined) { break s; }
		...
		githubLink = "Thank you for your view";
		level1Cols = 40;
		level2Cols = 60;
		index = 1;
		if ($pkg === $mainPkg) {
